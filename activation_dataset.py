...
from activation_dataset_utils import *
...
def setup_token_data(cfg, tokenizer, model):
    sentence_dataset = make_sentence_dataset(cfg.dataset_name_or_path)
    tokenized_sentence_dataset, bits_per_byte = chunk_and_tokenize(sentence_dataset, tokenizer, max_length=cfg.context_length)
    token_loader = DataLoader(tokenized_sentence_dataset, batch_size=cfg.batch_size, shuffle=True)
    return token_loader
